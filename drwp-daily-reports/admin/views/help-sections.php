<?php
/**
 * Help section bodies, keyed by $slug. Shared between the tabbed
 * admin view (help-page.php) and the print view (help-print.php).
 */
if (!defined('ABSPATH')) exit;
$slug = isset($slug) ? (string) $slug : 'intro';
switch ($slug):
case 'intro': ?>
    <div class="card">
