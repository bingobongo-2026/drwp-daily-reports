...
class DRWP_AI {
    ...
    public static function draft_public_post($report_id) {
        ...
        $system = 'あなたは建設・サービス業の会社の広報担当ライターです。'
            ...
            . "\n\n"
            . "【タイトルの作り方】\n"
            . "タイトルは「何を、どこで、いつ」やったかが一目で分かるよう、次の構造を必ず守ってください:\n"
            . "  [どこで(案件名や現場・場所)] で [何を(具体的な作業内容)] (いつ: YYYY年M月D日 または M月D日)\n"
            . "例:\n"
            . "  「山田邸新築工事で上棟・屋根工事を実施しました（2026年6月11日）」\n"
            . "  「田中邸外構リニューアル現場の現地調査を行いました（6月13日）」\n"
